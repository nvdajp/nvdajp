...
index 2aa2cab186..84d2e2de9b 100644
--- "a/F:\\nvda\\gh\\alphajp-251219\\source\\globalCommands.py"
+++ "b/F:\\nvda\\gh\\alphajp\\source\\globalCommands.py"
@@ -7,7 +7,6 @@
...
@@ -278,11 +281,7 @@ def script_reportCurrentLine(self, gesture):
 		if scriptCount == 0:
...
@@ -411,9 +410,7 @@ def script_reportCurrentSelection(self, gesture):
 				return
...
@@ -456,7 +453,6 @@ def script_dateTime(self, gesture):
 					None,
 					None,
 				)
...
@@ -799,19 +795,18 @@ def script_toggleReportStyle(self, gesture):
...
@@ -1422,11 +1417,7 @@ def script_navigatorObject_current(self, gesture: inputCore.InputGesture):
 			text = " ".join(textList)
...
@@ -1861,11 +1852,13 @@ def script_review_currentLine(self, gesture: inputCore.InputGesture):
 		if scriptCount == 0:
 			speech.speakTextInfo(info, unit=textInfos.UNIT_LINE, reason=controlTypes.OutputReason.CARET)
 		else:
+			# BEGIN JP PATCH (character description mode)
...
+			# END JP PATCH
 	...
 	@script(
 		description=_(
@@ -2067,7 +2060,7 @@ def script_review_currentWord(self, gesture: inputCore.InputGesture):
 			speech.spellTextInfo(
 				info,
 				useCharacterDescriptions=(scriptCount > 1),
...
+				useDetails=(scriptCount > 1 and characterDescriptionMode),  # nvdajp
 	...
 	@script(
@@ -2186,7 +2179,7 @@ def script_review_previousCharacter(self, gesture: inputCore.InputGesture):
 		speakOnDemand=True,
 	)
...
@@ -2200,12 +2193,17 @@ def script_review_currentCharacter(self, gesture: inputCore.InputGesture):
...
@@ -2230,7 +2228,9 @@ def script_review_currentCharacter(self, gesture: inputCore.InputGesture):
...
@@ -2239,6 +2239,7 @@ def script_review_currentCharacter(self, gesture: inputCore.InputGesture):
 				# Translators: character description mode
...
+			# END JP PATCH
 	...
 	@script(
 		description=_(
@@ -2530,7 +2531,6 @@ def script_restart(self, gesture):
 	@script(
...
@@ -2578,7 +2578,7 @@ def _reportFormattingHelper(self, info, browseable=False):
 			"reportColor",
 			"reportStyle",
 			"reportAlignment",
-			"reportSpellingErrors",
+			"reportSpellingErrors2",
 			...
 			"reportLineSpacing",
@@ -2878,11 +2878,13 @@ def script_reportCurrentFocus(self, gesture: inputCore.InputGesture):
...
@@ -2967,9 +2969,11 @@ def script_spellStatusLine(self, gesture):
...
+			# END JP PATCH
 	...
 	@script(
 		description=_(
@@ -3116,9 +3120,11 @@ def script_title(self, gesture: inputCore.InputGesture):
 		if repeatCount == 0:
 			ui.message(title)
 		elif repeatCount == 1:
+			# BEGIN JP PATCH (character description mode)
...
@@ -3983,9 +3989,7 @@ def script_reportClipboardText(self, gesture):
 			if repeatCount == 0:
 				ui.message(text)
 			else:
-				speech.speakSpelling(
