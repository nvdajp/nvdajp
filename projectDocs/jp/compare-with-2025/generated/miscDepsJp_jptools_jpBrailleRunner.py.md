...
@@ -212,9 +236,7 @@ def pass2(verboseMode=False):
 				else:
 					correct_inpos1 = None
 				# merged inpos
...
@@ -233,15 +255,28 @@ def pass2(verboseMode=False):
...
@@ -259,11 +294,44 @@ def pass2(verboseMode=False):
