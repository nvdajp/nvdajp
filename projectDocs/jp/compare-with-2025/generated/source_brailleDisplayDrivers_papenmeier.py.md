...
**Source**: `F:\nvda\gh\alphajp-251219\source\brailleDisplayDrivers\papenmeier.py`  
...
```diff
diff --git "a/F:\\nvda\\gh\\alphajp-251219\\source\\brailleDisplayDrivers\\papenmeier.py" "b/F:\\nvda\\gh\\alphajp-260109\\source\\brailleDisplayDrivers\\papenmeier.py"
index e17e762..2bd13ac 100644
--- "a/F:\\nvda\\gh\\alphajp-251219\\source\\brailleDisplayDrivers\\papenmeier.py"
+++ "b/F:\\nvda\\gh\\alphajp-260109\\source\\brailleDisplayDrivers\\papenmeier.py"
@@ -20,6 +20,7 @@
 try:
...
+	log.debug("Failed to import ftdi2.", exc_info=True)
 ...
 # for bluetooth
 import hwPortUtils
@@ -166,18 +167,18 @@ def connectBluetooth(self):
 							)
...
@@ -400,6 +401,7 @@ def terminate(self):
 				self._dev.close()
 			self._dev = None
 		except:  # noqa: E722
...
@@ -409,6 +411,7 @@ def display(self, cells: List[int]):
 		try:
...
@@ -422,10 +425,11 @@ def _handleKeyPresses(self):
 		try:
...
+					log.debug("Failed to connect to device.", exc_info=True)
 			...
 			if s:
@@ -437,6 +441,7 @@ def _handleKeyPresses(self):
