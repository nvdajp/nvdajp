...
**Source 2025.3.x jp**: `F:\nvda\gh\alphajp-251219\source\appModules\explorer.py`  
...
```diff
diff --git "a/F:\\nvda\\gh\\alphajp-251219\\source\\appModules\\explorer.py" "b/F:\\nvda\\gh\\alphajp-260109\\source\\appModules\\explorer.py"
index 4888034..7f71607 100644
--- "a/F:\\nvda\\gh\\alphajp-251219\\source\\appModules\\explorer.py"
+++ "b/F:\\nvda\\gh\\alphajp-260109\\source\\appModules\\explorer.py"
@@ -45,21 +45,6 @@ def _get_container(self):
...
@@ -164,47 +149,6 @@ def event_show(self):
 			super().event_show()
...
@@ -269,14 +213,6 @@ def chooseNVDAObjectOverlayClasses(self, obj, clsList):  # NOQA: C901
...
-
 		if windowClass == "ToolbarWindow32":
 			if role != controlTypes.Role.POPUPMENU:
 				try:
@@ -326,18 +262,8 @@ def chooseNVDAObjectOverlayClasses(self, obj, clsList):  # NOQA: C901
