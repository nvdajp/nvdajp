...
**Current**: `F:\nvda\gh\alphajp\miscDepsJp\jptools\jtalk\custom_dic_maker.py`
...
index 416336448e..3612e8b1cc 100644
--- "a/F:\\nvda\\gh\\alphajp-251219\\miscDepsJp\\jptools\\jtalk\\custom_dic_maker.py"
+++ "b/F:\\nvda\\gh\\alphajp\\miscDepsJp\\jptools\\jtalk\\custom_dic_maker.py"
@@ -9,7 +9,7 @@
...
+    {"text": "一日中", "braille": "1ニチジュー", "speech": "イチニチジュー", "cost": -1000, "pos": "名詞,一般,*,*,*,*"},
...
+    {"text": "一念岩", "braille": "イチネン イワ", "speech": "イチネンイワ", "cost": -1000, "pos": "名詞,一般,*,*,*,*"},
...
+        "cost": -1000,
     ...
     {
         "text": "ギアボックス",
@@ -1458,7 +1469,12 @@ def __init__(self, a):
