...
**Source**: `F:\nvda\gh\alphajp-251219\source\winBindings\user32.py`  
...
```diff
diff --git "a/F:\\nvda\\gh\\alphajp-251219\\source\\winBindings\\user32.py" "b/F:\\nvda\\gh\\alphajp-260109\\source\\winBindings\\user32.py"
index 85b7ddb..3fc6462 100644
--- "a/F:\\nvda\\gh\\alphajp-251219\\source\\winBindings\\user32.py"
+++ "b/F:\\nvda\\gh\\alphajp-260109\\source\\winBindings\\user32.py"
@@ -8,7 +8,9 @@
 from ctypes import (
...
@@ -84,7 +109,7 @@ class WNDCLASSEXW(Structure):
...
@@ -97,7 +122,7 @@ class WNDCLASSEXW(Structure):
 )
...
@@ -114,7 +139,7 @@ class WNDCLASSEXW(Structure):
...
+SetWindowsHookEx = WINFUNCTYPE(None)(("SetWindowsHookExW", dll))
 SetWindowsHookEx.argtypes = (
 	c_int,  # idHook
 	HOOKPROC,  # lpfn
@@ -123,7 +148,7 @@ class WNDCLASSEXW(Structure):
 )
...
@@ -138,7 +163,68 @@ class WNDCLASSEXW(Structure):
 )
...
+CreateWindowEx = WINFUNCTYPE(None)(("CreateWindowExW", dll))
 ...
 .. seealso::
@@ -160,7 +246,7 @@ class WNDCLASSEXW(Structure):
 )
...
+RegisterClassEx = WINFUNCTYPE(None)(("RegisterClassExW", dll))
 ...
 .. seealso::
@@ -171,7 +257,7 @@ class WNDCLASSEXW(Structure):
 )
...
+UnregisterClass = WINFUNCTYPE(None)(("UnregisterClassW", dll))
 ...
 .. seealso::
@@ -183,7 +269,7 @@ class WNDCLASSEXW(Structure):
 )
...
+BeginPaint = WINFUNCTYPE(None)(("BeginPaint", dll))
 ...
 .. seealso::
@@ -195,7 +281,7 @@ class WNDCLASSEXW(Structure):
 )
...
+EndPaint = WINFUNCTYPE(None)(("EndPaint", dll))
 ...
 .. seealso::
@@ -207,7 +293,7 @@ class WNDCLASSEXW(Structure):
 )
...
+OpenClipboard = WINFUNCTYPE(None)(("OpenClipboard", dll))
 ...
 .. seealso::
@@ -218,7 +304,7 @@ class WNDCLASSEXW(Structure):
 )
...
+CloseClipboard = WINFUNCTYPE(None)(("CloseClipboard", dll))
 ...
 .. seealso::
@@ -227,7 +313,7 @@ class WNDCLASSEXW(Structure):
...
+GetClipboardData = WINFUNCTYPE(None)(("GetClipboardData", dll))
 ...
 .. seealso::
@@ -238,7 +324,7 @@ class WNDCLASSEXW(Structure):
 )
...
+SetClipboardData = WINFUNCTYPE(None)(("SetClipboardData", dll))
 ...
 .. seealso::
@@ -249,3 +335,1279 @@ class WNDCLASSEXW(Structure):
 	HANDLE,  # hMem
 )
