...
**Current**: `F:\nvda\gh\alphajp\miscDepsJp\jptools\jtalk\make_jdic.py`
...
index 709f80e46c..102ea556ac 100644
--- "a/F:\\nvda\\gh\\alphajp-251219\\miscDepsJp\\jptools\\jtalk\\make_jdic.py"
+++ "b/F:\\nvda\\gh\\alphajp\\miscDepsJp\\jptools\\jtalk\\make_jdic.py"
@@ -7,7 +7,6 @@
 import subprocess
...
@@ -35,8 +34,9 @@ def _log_redirect(repo_root: Path, mode: str):
         yield log_path, fp
...
@@ -57,16 +57,16 @@ def convert_file(src_file, src_enc, dest_file, dest_enc, apply_filter=False):
