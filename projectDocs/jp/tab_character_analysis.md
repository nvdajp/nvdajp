...
* 実装:
  ...
  # text2mecab.py
* TAB_PLACEHOLDER = "\uE000"
* *xt = txt.replace("\t", TAB_PLACEHOLDER)
* *xt = unicodedata.normalize("NFKC", txt)
* *xt = text2mecab_convert(txt)  # ASCII→全角変換
* *xt = txt.replace(TAB_PLACEHOLDER, " ")
* *xt = unicodedata.normalize("NFKD", txt)  # 全角→半角に戻す
* *``
* *果:
* * ✅ MeCab クラッシュなし
...
* *態: **失敗 - クラッシュ**
* *har.def に追加: `0x2800 SPACE  # BRAILLE PATTERN BLANK for TAB_CODE`
* *題:
