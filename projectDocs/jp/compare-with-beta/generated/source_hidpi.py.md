...
+class _HIDP_VALUE_CAPS_U1_NOT_RANGE(Structure):
 	_fields_ = [
 		("Usage", USAGE),
 		("Reserved1", USAGE),
@@ -105,6 +94,35 @@ class _HIDP_VALUE_AND_BUTTON_CAPS_U1_NOT_RANGE(Structure):
 	]
...
@@ -113,14 +131,6 @@ class _HIDP_VALUE_AND_BUTTON_CAPS_U1(Union):
...
-
 	_fields_ = [
 		("UsagePage", USAGE),
 		("ReportID", UCHAR),
@@ -144,15 +154,17 @@ class HIDP_VALUE_CAPS(Structure):
 		("LogicalMax", LONG),
 		("PhysicalMin", LONG),
 		("PhysicalMax", LONG),
