...
@@ -262,31 +60,16 @@ class SecureDesktopHandler:
...
@@ -300,19 +83,11 @@ def terminate(self) -> None:
...
+			log.debug("IPC file already removed")
 	...
 	@property
@@ -357,62 +132,15 @@ def enterSecureDesktop(self) -> None:
...
@@ -437,10 +165,9 @@ def enterSecureDesktop(self) -> None:
...
@@ -469,20 +196,10 @@ def leaveSecureDesktop(self) -> None:
 			)
...
@@ -490,31 +207,10 @@ def initializeSecureDesktop(self) -> Optional[ConnectionInfo]:
...
@@ -523,7 +219,7 @@ def initializeSecureDesktop(self) -> Optional[ConnectionInfo]:
...
@@ -539,13 +235,6 @@ def initializeSecureDesktop(self) -> Optional[ConnectionInfo]:
 		except Exception:
