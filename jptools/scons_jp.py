...
def register_jp_builders(env: Any, dist_target: Any | None = None) -> None:
	...
	# Note: jtalkSync output files (sys.dic, libmecab.dll, libopenjtalk.dll) are not added as dependencies
	# to avoid circular dependency. Instead, we rely on the fact that 'source' depends on jtalkSync
	# (sconstruct L402), so jtalkSync will be executed when needed. SCons automatically tracks
	# the relationship between the stamp file and the output files generated by _sync_jtalk_assets.
