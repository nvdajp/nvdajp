...
# This file may be used under the terms of the GNU General Public License, version 2 or later, as modified by the GNU General Public License.
...
__getattr__ = handleDeprecations(
	...
	# BEGIN JP PATCH
	MovedSymbol("getLandmarkLabel", "braille.labels"),
	MovedSymbol("getLandmarkLabels", "braille.labels"),
	MovedSymbol("getNegativeStateLabels", "braille.labels"),
	MovedSymbol("getPositiveStateLabel", "braille.labels"),
	MovedSymbol("getPositiveStateLabels", "braille.labels"),
	MovedSymbol("getRoleLabel", "braille.labels"),
	MovedSymbol("useRawLabels", "braille.labels"),
	# END JP PATCH
)
