...
ARIA details noVbuf
	...
	[Tags]	chrome_annotations	robot:skip
...
# BEGIN JP PATCH (WAIC tests - Japanese web accessibility compliance)
## chrome_waic tests
### WAIC aria-describedby tests (AS-0029-01 through AS-0029-08)
# These tests verify Japanese aria-describedby behavior.
# They use strings_match_any to accept both English and Japanese role names,
# so they pass in both English CI and Japanese local environments.
