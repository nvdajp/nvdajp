...
DEPRECATED = {
	...
	# BEGIN JP PATCH
	"getLandmarkLabel": braille.labels.getLandmarkLabel,
	"getLandmarkLabels": braille.labels.getLandmarkLabels,
	"getNegativeStateLabels": braille.labels.getNegativeStateLabels,
	"getPositiveStateLabel": braille.labels.getPositiveStateLabel,
	"getPositiveStateLabels": braille.labels.getPositiveStateLabels,
	"getRoleLabel": braille.labels.getRoleLabel,
	"useRawLabels": braille.labels.useRawLabels,
	# END JP PATCH
}
